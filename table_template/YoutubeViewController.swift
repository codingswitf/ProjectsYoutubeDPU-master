...
class YoutubeViewController: UIViewController, NSURLSessionDelegate,
    ...
    var apiKey = "AIzaSyB1slcolvG9eZC0JqXzY2BgJpcOU3Qf-VU"
    ...
    func URLSession(session: NSURLSession, downloadTask: NSURLSessionDownloadTask, didFinishDownloadingToURL location: NSURL) {
        ...
        var error: NSError?
        var destinationPath = try! manager.URLForDirectory(.DocumentDirectory,
    ...
    */
    ...
    @IBAction func ButtonOk(sender: AnyObject) {
        ...
        var urlString = "https://www.googleapis.com/youtube/v3/search?part=snippet&q=\(yttf.text)&type=\(type)&maxResults=25&key=\(apiKey)"
        ...
        if let id = segue.identifier {
            switch id {
                case "seg_music":
                    ...
                    dvc.pic = videosArray[id.row]["thumbnail"] as! String
...
extension YoutubeViewController: UITextFieldDelegate {
    ...
    func textFieldShouldReturn(textField: UITextField) -> Bool {
        ...
        // Form the request URL string.
        var urlString = "https://www.googleapis.com/youtube/v3/search?part=snippet&order=viewCount&q=\(textField.text)&type=\(type)&maxResults=25&key=\(apiKey)"
        urlString = urlString.stringByAddingPercentEscapesUsingEncoding(NSUTF8StringEncoding)!
